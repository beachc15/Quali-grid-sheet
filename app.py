...
<style>
  ...
  .nasa-header h1 {
    ...
    letter-spacing: 0.05em; color: #ffffff; margin: 0 0 0.25rem;
  }
  .nasa-header p { color: #a0aec0; font-size: 0.95rem; margin: 0; }
  .accent { color: #e94560; }
  ...
  .grid-table { width: 100%; border-collapse: collapse; font-size: 0.92rem; margin-top: 1rem; }
  ...
  .grid-table td { padding: 0.6rem 1rem; border-bottom: 1px solid #2d3748; color: #e8e8e8; }
  .grid-table td.pos { color: #a0aec0; font-size: 0.85rem; }
  .grid-table td.laptime {
    font-family: 'Barlow Condensed', sans-serif;
    font-size: 1.05rem; color: #68d391; font-weight: 600;
  }
  ...
  div[data-testid="stButton"] > button {
    ...
    padding: 0.6rem 2rem !important; border-radius: 4px !important; width: 100%;
  }
...
“Tip: Try a shorter name fragment, or use ‘Choose from list’ mode.”
...
“Tip: Try a shorter fragment like ‘E30’ instead of ‘Spec E30’, or leave blank.”
% class_filter
)
st.stop()
...
“<td>%s</td>”
“</tr>”
) % (pos, row[“Driver”], row[“Best Lap”], row[“Event”], row[“Session”], row[“Date”])
...
<table class="grid-table">
  <thead>
    <tr>
      ...
      <th>Event</th><th>Session</th><th>Date</th>
    </tr>
  </thead>
  <tbody>%s</tbody>
</table>
...
with col2:
st.caption(“You can also select the table above and paste directly into Excel.”)